<template>
  <scroll-view :scrollY="true">
    ...
    <button type="primary" @tap="tapHandle">分享图片</button>
...
export default {
  setup() {
    ...
    const showRedPackage = function () {
      Taro.showRedPackage({
        url: "https://img1.baidu.com/it/u=4049022245,514596079&fm=253&app=138&size=w931&n=0&f=JPEG&fmt=auto?sec=1702054800&t=f78ab44b6c79d50010356b808487b695",
        success(res) {
